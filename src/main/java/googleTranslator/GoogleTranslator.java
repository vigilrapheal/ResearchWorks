...
public class GoogleTranslator {
	public static void main(String[] args) throws Exception {
		...
		// String translatedText = Translate.execute("���",Language.CHINESE_SIMPLIFIED,
		// Language.ENGLISH);
		...
		Translate.setHttpReferrer("https://translate.google.com/");
		String text = "hfgfy ydrhes fdgs ";

		// automatically language dector
		Language language = getDectLanguage(text);
		// translator
//		String translateString = getTranslation("ʳƷ");
